...
for i in range (0,2000 ):
    cur.execute("Insert into istoric_senzori values('gaz',{0},TO_DATE('{1}/{4}/{2} {5}:{3}:00','DD/MM/YY HH:MI:SS'),825)".format(i,randint(1,11),randint(2014,2018),randint(0,59),randint(1,11),randint(1,12)))
    cur.execute("commit");
cur.close()
connection.close()
'''
